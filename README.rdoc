...
This version adds support for a 'trapped' parameter to text fields and textareas. If it's present, a bot trap is added to the field. It works like this:
...
* A dummy field is added to the form with the real field name, and hidden from humans with a style tag (which should really be less obvious)
