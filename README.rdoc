...
* If anything is entered into the dummy field, we invalidate the form (with an error on eg 'email_trap')
* Before the rest of the validations, the real field names are restored

This is sometimes called an inverse captcha. It works surprisingly well at screening out form bots. All you need to put in your form is this:
